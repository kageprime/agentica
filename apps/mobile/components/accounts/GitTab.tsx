    ...
    >
      ...
      <View style={{ marginTop: 10 }}>
        {installationsQuery.isLoading ? (
          ...
          <View style={{ alignItems: 'center', paddingVertical: 30, gap: 12 }}>
            ...
            <Text style={{ fontSize: 13.5, color: c.muted, textAlign: 'center' }}>No GitHub connections. Connect the GitHub App to import repositories.</Text>
          </View>
        ) : (
          <View>
      ...
      <View style={{ flexDirection: 'row', alignItems: 'flex-start', gap: 9 }}>
        ...
        <Text style={{ flex: 1, fontSize: 12, lineHeight: 17, color: c.muted }}>
          The platform stores the GitHub App installation on the account. It's a platform credential — individual projects link to repos through it.
        </Text>
      </View>
    </ScrollView>
  );
