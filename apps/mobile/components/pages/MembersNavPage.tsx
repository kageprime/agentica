 ...
 *
 * Cards:
 *   • Invite by email — add a user at a chosen role; non-Kortix emails get
 *     an invitation.
...
function InviteCard({ projectId, isDark }: { projectId: string; isDark: boolean }) {
  ...
  return (
    <View style={{ borderRadius: 16, borderWidth: 1, borderColor: c.border, backgroundColor: c.cardBg, padding: 16 }}>
      <CardHeader title="Invite by email" description="Add a user. If they don't have an account yet, they'll get an invitation email." isDark={isDark} />
