/**
 * The App viewer — who is looking at an App, told to the App itself.
 *
 ...
 *
 * The user signs in to the platform once. Every App they open is authenticated
 ...
 *                API. The viewer's own IAM role is still the ceiling.
 */
...
/**
 * The viewer's App-scoped token, added alongside the identity when the
