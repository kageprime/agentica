...
const COPY: Record<Exclude<AuthEmailActionType, 'reauthentication'>, Copy> = {
  signup: {
    ...
    lead: 'Confirm this address to finish creating your account.',
    cta: 'Confirm email',
  ...
  invite: {
    ...
    lead: 'Accept the invitation to create your account.',
    cta: 'Accept invite',
  ...
  email_change: {
    ...
    lead: 'Confirm this change to move your account to the new address.',
    cta: 'Confirm change',
  ...
  email_change_current: {
    ...
    lead: 'Confirm from your current address to move your account.',
    cta: 'Confirm change',
    note: 'If you did not request this change, reset your password immediately.',
  },
  email_change_new: {
