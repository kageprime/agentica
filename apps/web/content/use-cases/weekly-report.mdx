...
description: The reporting agent we run on the platform — connected to our Postgres database and Slack. Every Monday it queries the metrics, writes the report with commentary on what moved, and posts it.
date: "2026-05-20"
author: team
tags:
  - Data
...
We run a reporting agent on the platform that builds it. A Monday cron queries the
...
On the platform, a Monday cron triggers a reporting agent. Each run spawns an isolated
