...
We run an escalation-manager agent on the platform that checks the Plain queue every
...
On the platform, a cron fires every 15 minutes and spawns a fresh agent session. It
