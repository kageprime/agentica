...
We run an agent on the platform that does the research and the writing per contact, then
...
On the platform, a periodic sweep triggers the agent in a fresh session (a cloud
