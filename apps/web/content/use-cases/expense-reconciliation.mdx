...
description: The finance agent we run on the platform — connected to Stripe, the bank feed, and Google Sheets. Each month it matches transactions against invoices, flags mismatches, and posts a summary, escalating anything it can't match.
date: "2026-04-15"
author: team
tags:
  - Finance
...
how we run that on the platform — the connections, the steps, and the guardrails.
...
On the platform, a monthly **cron** triggers a reconciliation agent. Each run spawns
...
relevant controls on the platform:
