...
We run a daily agent on the platform that does the gathering. It reads each person's
...
On the platform, a cron fires once each weekday morning and spawns an agent. It reads
