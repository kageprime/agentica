...
We run a feedback agent on the platform that gathers those sources on a schedule,
...
On the platform, a scheduled cron triggers an agent. It spawns an isolated session (a
