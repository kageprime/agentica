...
We run a phishing-triage agent on the platform that checks that inbox every 15
...
On the platform, a cron fires every 15 minutes and spawns a fresh agent session with
