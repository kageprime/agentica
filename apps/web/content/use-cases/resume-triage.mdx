...
We run an agent on the platform that does the first read consistently. Each application
...
On the platform, each inbound application triggers an agent. The application spawns an
