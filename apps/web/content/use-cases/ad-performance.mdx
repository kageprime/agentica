...
We run an ad-performance agent on the platform that reads campaign spend and
...
On the platform, a daily cron spawns a fresh agent session. It reads campaign spend
