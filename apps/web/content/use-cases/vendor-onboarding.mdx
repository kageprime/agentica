...
We run a vendor-onboarding agent on the platform that checks the inbox every day,
...
On the platform, a daily cron re-prompts a fresh session with no memory of the prior
