...
We run a churn-risk agent on the platform that reads those signals every day and posts a
...
On the platform, a daily cron triggers an agent. It spawns an isolated session (a cloud
