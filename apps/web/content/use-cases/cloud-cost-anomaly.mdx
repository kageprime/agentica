...
We run a cloud-cost anomaly agent on the platform that watches AWS spend every day,
...
On the platform, a daily cron re-prompts one persistent agent session with read-only
