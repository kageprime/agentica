...
We run offboarding through an agent on the platform. On a schedule, the agent checks
...
On the platform, an agent checks Okta on a schedule for newly marked departures. Each
