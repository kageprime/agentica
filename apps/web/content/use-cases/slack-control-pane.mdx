...
To give the agent a new capability, you **connect the platform to the platform once**.
...
<Callout title="The setup" tone="accent">
  Connect Slack as the **channel**, connect each platform to the platform as a scoped
