...
description: The content-refresh agent we run on the platform — a weekly agent that finds decaying marketing and blog pages via Search Console, refreshes the copy, stats, and internal links, and opens a PR for review.
date: "2026-04-22"
author: team
tags:
  - Marketing
...
We run a content-refresh agent on the platform that watches for that decay every
...
On the platform, a weekly cron re-prompts a **persistent session** — the same agent,
