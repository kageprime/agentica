...
We run an NPS analysis agent on the platform that reads new survey responses every week
...
On the platform, a weekly cron triggers an agent. It spawns an isolated session (a cloud
