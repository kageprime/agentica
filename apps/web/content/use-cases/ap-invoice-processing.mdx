...
We run an accounts-payable agent on the platform that checks the inbox every 15 minutes,
...
On the platform, a cron fires every 15 minutes. Each firing spawns a fresh agent
