...
We run an agent on the platform that drafts the first version. When an incident
...
On the platform, resolving an incident triggers an agent. It reads the incident channel
