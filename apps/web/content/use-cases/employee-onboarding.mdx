...
our HR system. This writes up how we run that on the platform — the connections, the
...
On the platform, a new-hire record triggers an agent. Each new hire runs in its own
...
question. The relevant controls on the platform:
