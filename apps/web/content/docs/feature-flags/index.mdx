---
title: Feature flags
description: Turn a surface on for one project, and read what every flag gates.
---

A feature flag turns one surface on for one project. Any surface can
...
|---|---|
| `voice`, `teams`, `agentmail_email` | The platform re-runs channel-connector materialization, so the connector appears or disappears with the flag. |
