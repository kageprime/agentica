...
- **Kortix-managed repo** — the platform creates and hosts a private repo. Default.
...
and its memory. Keep it small — the platform clones it into every session.
...
| `agents` | per-agent grants: connectors, secrets, skills, CLI permissions |
