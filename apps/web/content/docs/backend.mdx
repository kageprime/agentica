---
title: Platform as a Backend
description: Start and manage sessions from your backend with explicit connector, model, context, and secret scope.
---

Use an API key to start sessions from your server. Each session has one
owner, one project, and one cost record.
