...
This page shows how the pieces of a self-hosted instance fit
...
Self-hosted the platform is one generic Docker Compose system, not a family of
...
- **Caddy** — reverse proxy and ACME TLS. This service is only rendered
...
- **The Supabase Docker distribution** — Kong, GoTrue auth, PostgREST,
  ...
  connection pooler. The platform vendors this from upstream Supabase and pins
