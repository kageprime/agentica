---
title: Self-hosting
description: Run your own instance with Docker Compose, on a VPS or for evaluation.
---

The platform runs as one Docker Compose stack: the frontend, the API, the LLM gateway, and the Supabase distribution. This page shows the three ways to install it, how updates work, and how to back up your data.
...
To try the platform with no domain, use a Cloudflare tunnel instead of a domain:
...
The platform has no separate backup system. Each instance stores its data as two
