  ...
  reach: {
    ...
    rows: [
      ...
      },
      {
        ...
        v: 'Reached as a connector you define: an OpenAPI or Postman description, a GraphQL endpoint, a raw HTTP base URL, or a remote MCP server. The platform reads the source, works out the authentication, and turns each operation into a tool with its own Allow, Ask or Block.',
      },
      {
        k: 'The repo',
