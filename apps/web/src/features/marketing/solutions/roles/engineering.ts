...
export const engineering: RoleContent = {
  ...
  reach: {
    ...
    rows: [
      ...
      {
        k: 'Your own services',
        v: 'Point the platform at an OpenAPI or Postman spec, a GraphQL endpoint, a remote MCP server, or a bare HTTP base URL. It reads the source, works out the authentication, and turns every operation into a tool the agent can call.',
      },
    ],
    footnote:
  ...
  control: {
    ...
    rows: [
      ...
      },
      {
        ...
        v: 'The sandbox carries one project-scoped token and no third-party keys. The gateway decrypts the real credential server-side and attaches it to the outbound call. A runtime secret you deliberately grant is different — that one is a real environment value the agent can read, and it is meant to be.',
      },
      {
        id: 'audit',
