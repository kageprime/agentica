...
export const declared = {
  ...
  notes: [
    ...
    'The default image already carries the runtime layer.',
  ...
  rows: [
    {
      ...
      v: 'Sessions never share a filesystem, a process table, or a network namespace. On the platform’s own Platinum compute the boundary is a Cloud Hypervisor microVM; Daytona and E2B are also supported, and we will tell you which one you are on.',
    },
    {
      id: 'secrets',
...
export const closing = {
  ...
  sub: 'Open source, with support for any AI model. Use Cloud or run it on your own systems.',
  ctaPrimary: 'Start a session',
  ctaPrimaryHref: '/auth',
