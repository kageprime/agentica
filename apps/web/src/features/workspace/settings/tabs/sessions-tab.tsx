...
export const DEFAULT_SESSIONS_TAB_COPY: SessionsTabCopy = {
  ...
  notificationTypesCopy: {
    ...
    onQuestion: { label: 'Questions', description: 'When the platform needs your input to continue' },
    onPermission: {
      label: 'Permission requests',
      description: 'When the platform needs permission to use a tool',
    },
  },
...
const NOTIFICATION_TYPE_TOGGLES: {
  ...
  },
  {
    ...
    label: 'Questions',
    description: 'When the platform needs your input to continue',
  },
  {
    key: 'onPermission',
