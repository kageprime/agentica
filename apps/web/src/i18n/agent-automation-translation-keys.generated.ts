...
export const AGENT_AUTOMATION_TRANSLATION_KEYS: Readonly<Record<string, string>> = {
  ...
  'An external service POSTs to the trigger URL. The platform checks the signature, renders the payload into the prompt, and starts the session. A payload that fails your filter is accepted and ignored.':
    'textdd80c157b521',
  ...
  'Both types name the agent they run as, and inherit that agent’s deny-by-default reach.':
    'textbefd6c156056',
  'By default every fire is a clean slate. When the work is a running thread rather than a fresh errand, a trigger can re-prompt a session it already owns. The platform tries the modes in order and falls through on failure, so a fire never simply disappears.':
    'textab4962ab35a6',
  ...
  'Open source and self-hostable. Any model, your keys. Cloud, your own VPC, or fully on-prem.':
    'text1d9a8dde5629',
  'Open source, with support for any AI model. Use Cloud or run it on your own systems.':
    'text5b6a9e140d4b',
  ...
  'Sessions never share a filesystem, a process table, or a network namespace. On the platform’s own Platinum compute the boundary is a Cloud Hypervisor microVM; Daytona and E2B are also supported, and we will tell you which one you are on.':
    'text05e646f156e2',
  ...
  'The default image already carries the runtime layer.': 'text09761bceefe9',
