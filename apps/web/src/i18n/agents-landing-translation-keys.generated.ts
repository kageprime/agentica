...
export const AGENTS_LANDING_TRANSLATION_KEYS: Readonly<Record<string, string>> = {
  ...
  'An agent decides whether to load a skill from its name and description alone. A vague description means the skill never fires — which is why the description reads like a list of the things a person would actually say.':
    'textf4b3042a5a94',
  'An agent has exactly two homes. The markdown file carries how it thinks — its prompt, its mode, its model, its permission tree — and it is a stock OpenCode agent file, because the platform adds no dialect to it. The manifest block carries what it may touch. Nothing about an agent lives in a database you cannot read.':
    'text7b6762537105',
  ...
  'Browse the marketplace without signing in. The platform ships its own registry — 62 agents, 61 skills and 62 project templates — and you can switch on curated outside registries with one click. None load by default.':
    'text43298f298ad8',
  ...
  'Excerpt of the default agent in every new project.': 'textbb650fd852da',
  ...
  'How the platform is secured': 'textae799eb0e384',
  ...
  'Cloud, your own VPC, or your own on-prem network. It is open source, so you can read every line of what you are trusting.':
    'textb6de6f87c92d',
  ...
  'Most tools hand you one layer and rent you the rest. The platform is all of them, open source, running wherever you put it.':
    'text3c579d4ff304',
