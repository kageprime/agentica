...
/* ── 2 · the credential broker ──────────────────────────────────────────────
   The centrepiece. Steps: 0 the shape · 1 the agent asks · 2 the platform resolves ·
...
export function BrokerDiagram({ step }: { step: number }) {
  ...
  const captions = [
    ...
    'The platform checks that this agent may use this connector, applies the policy, and decrypts the credential on its own side of the wall.',
