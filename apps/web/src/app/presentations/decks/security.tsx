...
export function useSlides(): SlideDef[] {
  ...
  return [
    /* ── open ────────────────────────────────────────────────────────────── */
    {
      ...
      notes:
        'If you are going to run a hundred agents inside your company, only one question really matters: what happens when one of them goes wrong?\n\nAn agent that can install anything, call anything and write anywhere is only safe if the walls are real. In the platform those walls sit below the agent, in the platform, where a prompt cannot talk its way past them.\n\nLet me show you.',
      node: (
        <Slide>
          <Rise i={0}>
    ...
    /* ── 01 · isolation ──────────────────────────────────────────────────── */
    {
      ...
      notes: [
        ...
        'I start a session. The platform cuts a branch and boots one machine for it — and that one-machine-per-session rule is a unique constraint in the database, not a convention two services agree to honour.\n\nThe agent in there can install packages, run code, break things.',
    ...
    /* ── 02 · credentials ────────────────────────────────────────────────── */
    {
      ...
      notes: [
        ...
        'The call crosses to our side. The platform checks this agent may use this connector, resolves the policy, and decrypts the credential here — outside the machine the model is driving.',
    ...
    /* ── 04 · who may reach what ─────────────────────────────────────────── */
    {
      ...
      notes: [
        ...
        'And here is the edge that does not exist. Most AI tools give the agent whatever the person who started it can reach. The platform has no inheritance edge to walk up.',
