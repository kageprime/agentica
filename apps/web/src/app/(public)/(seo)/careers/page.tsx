...
export const metadata: Metadata = {
  ...
  keywords:
    'Agentica careers, Agentica jobs, AI startup jobs, autonomous company jobs, San Francisco AI jobs, agent engineering, startup hiring',
  openGraph: {
    title: 'Careers at Agentica – Build the Autonomous Company OS',
    description:
