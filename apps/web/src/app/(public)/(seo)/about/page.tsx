...
export const metadata: Metadata = {
  ...
  keywords:
    'Agentica, about Agentica, self-driving company, AI-operated company, autonomous operations, agent workforce, AI agents, company automation',
  openGraph: {
    title: 'About Agentica – Building Self-Driving Companies',
    description:
