...
interface KortixComputerState {
  ...
  /** The project session behind `_activeSessionId`, when the layout
   ...
   *  boot→ready crossfade renames the layout from the session id to the
  ...
  devtools(
    (set, get) => ({
      ...
      setActiveSession: (
        ...
        // session id) crossfades into the real chat (layout id =
